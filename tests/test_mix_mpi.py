...
from mipego4ml.mipego import ContinuousSpace, NominalSpace, OrdinalSpace
from mipego4ml.mipego import RrandomForest, RandomForest
from mipego4ml.mipego import mipego
...
for func_name, func in functions.iteritems():
    if rank == 0:
        print
        "testing on function:", func_name, "dim:", dim
